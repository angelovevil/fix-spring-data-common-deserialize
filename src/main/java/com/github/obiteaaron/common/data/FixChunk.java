 ...
 * @since 1.8
 */
public abstract class FixChunk<T> implements Slice<T>, Serializable {

    private static final long serialVersionUID = -3557925183561514190L;

    private final List<T> content = new ArrayList<T>();
    private final Pageable pageable;

    /**
     * Creates a new {@link FixChunk} with the given content and the given governing {@link Pageable}.
     *
     * @param content must not be {@literal null}.
     * @param pageable can be {@literal null}.
     */
    public FixChunk(List<T> content, Pageable pageable) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof FixChunk<?>)) {
            return false;
        }

        FixChunk<?> that = (FixChunk<?>) obj;
