 ...
 */
public class FixPageImpl<T> extends FixChunk<T> implements Page<T> {

    private static final long serialVersionUID = -1373455045273429062L;
     ...
     */
    public FixPageImpl(List<T> content) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof FixPageImpl<?>)) {
            return false;
        }

        FixPageImpl<?> that = (FixPageImpl<?>) obj;
